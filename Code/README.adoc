...
image:src/main/resources/images/logo.png["EnergieClash Logo]
...
Die Skripts finden Sie hier: link:src/main/resources/scripts/[energieclash/src/main/resources/scripts]
...
In dieser Datei können die zur Auswahl stehenden Spielmodi festgelegt werden. Ausserdem kann die Sprache und die Spiellaenge eingestellt werden. Details zu der Konfiguration sind in der link:src/main/resources/app.properties[app.properties]- Datei beschrieben.
...
* Debug I2C on Pi - Führt das xref:src/main/resources/scripts/i2cTest.sh[I2cTest]-Skript auf dem RasPi aus, welches 10000-mal auf alle Output Adressen schreibt und die Fehler in der Konsole ausgibt.

* Debug LED on Pi - Führt das xref:src/main/resources/scripts/ledTest.sh[ledTest]-Skript auf dem RasPi aus. Welches nacheinander jede LED ansteuert.
