...
public class EnergieClashGameTutorialView extends AbstractSynchEnergieClashView {
    ...
    @FXML
    private HBox rolePaneHBox;
    @FXML
    private HBox tutorialPaneHBox;
    @FXML
    private HBox greyEnergyDetailPaneTextHBox;
    @FXML
    private HBox greyEnergyDetailPaneButtonHBox;
    @FXML
    ...
    protected void setupScreen() {
        ...
        startPaneVBox.getChildren().addAll(startLbl, createButtonHBox(
            buttons.stream()
    ...
    private void startButtonAction() {
        ...
        rolePaneVBox.getChildren().addAll(roleTitleLbl, roleTextLbl, rolePaneHBox);
        //Display buttons
        ...
        rolePaneHBox.getChildren().clear();
        rolePaneHBox.getChildren().addAll(greyEnergyButton, tutorialButton, skipButton);
    }
    ...
    private void greyEnergyButtonAction() {
        ...
        ButtonColor buttonColor = ButtonColor.RED;
        greyEnergyPaneVBox.getChildren().addAll(imageView, createButtonHBox(
    ...
    private void greyEnergyDetailButtonAction() {
        ...
        HBox skipButton = createButtonHBox(
            ...
            Translation.TUTORIAL_BUTTON_SKIP.getTextForLanguage(language));
        greyEnergyDetailPaneButtonHBox.getChildren().clear();
        greyEnergyDetailPaneButtonHBox.getChildren().addAll(tutorialButton, skipButton);
    }
    ...
    private void tutorialButtonAction() {
        ...
        tutorialPaneVBox.getChildren().addAll(textLbl, tutorialPaneHBox);
        ...
        HBox skipButton = createButtonHBox(
            buttons.stream().filter(button -> button.getButtonColor().equals(ButtonColor.RED)).findFirst().orElseThrow(
                () -> new NoSuchElementException(String.format("No such button with color %s", skipButtonColor))),
            Translation.TUTORIAL_BUTTON_SKIP.getTextForLanguage(language));
        tutorialPaneHBox.getChildren().clear();
        tutorialPaneHBox.getChildren().addAll(greyEnergyButton, skipButton);
    }
